...
| D6 | storage | Pluggable cache/store/event sinks | In-memory frontier and returned event log | Persisted/distributed operation needs a separate contract | 2026-08-12 |
